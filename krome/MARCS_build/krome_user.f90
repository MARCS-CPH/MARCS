...
module krome_user
  ...
  !  KROME 14.08.dev on 2022-10-11 13:45:27
  !  Changeset ed8d3da
  ...
  integer,parameter::KROME_idx_N2 = 1	!N2
  integer,parameter::KROME_idx_O = 2	!O
  integer,parameter::KROME_idx_NO = 3	!NO
  integer,parameter::KROME_idx_N = 4	!N
  integer,parameter::KROME_idx_O2 = 5	!O2
  integer,parameter::KROME_idx_CR = 6	!CR
  integer,parameter::KROME_idx_g = 7	!g
  integer,parameter::KROME_idx_Tgas = 8	!Tgas
  integer,parameter::KROME_idx_dummy = 9	!dummy
  ...
  integer,parameter::krome_nrea=4
  integer,parameter::krome_nmols=5
  integer,parameter::krome_nspec=9
...
contains
  ...
  function krome_get_names_header()
    ...
    use krome_getphys
    implicit none
    character*13::krome_get_names_header
    character*16::tmp(nspec)
    integer::i
