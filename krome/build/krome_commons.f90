...
module krome_commons
  ...
  ! *************************************************************
  integer,parameter::idx_N2=1
  integer,parameter::idx_O=2
  integer,parameter::idx_NO=3
  integer,parameter::idx_N=4
  integer,parameter::idx_O2=5
  integer,parameter::idx_CR=6
  integer,parameter::idx_g=7
  integer,parameter::idx_Tgas=8
  integer,parameter::idx_dummy=9
  integer,parameter::nrea=4
  integer,parameter::nmols=5
