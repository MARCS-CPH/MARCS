...
contains
  ...
  function get_mass()
    ...
    get_mass(1) = 4.6844455254632d-23	!N2
    get_mass(2) = 2.6768260145504d-23	!O
    get_mass(3) = 5.0190487772820004d-23	!NO
    get_mass(4) = 2.3422227627316d-23	!N
    get_mass(5) = 5.3536520291008d-23	!O2
    get_mass(6) = 0.d0	!CR
    get_mass(7) = 0.d0	!g
    get_mass(8) = 0.d0	!Tgas
    get_mass(9) = 0.d0	!dummy
  ...
  function get_imass_sqrt()
    ...
    get_imass_sqrt(1) = 146106959624.0866	!N2
    get_imass_sqrt(2) = 193281339990.54416	!O
    get_imass_sqrt(3) = 141152733143.5285	!NO
    get_imass_sqrt(4) = 206626443857.4815	!N
    get_imass_sqrt(5) = 136670546184.13641	!O2
    get_imass_sqrt(6) = 0.d0	!CR
    get_imass_sqrt(7) = 0.d0	!g
    get_imass_sqrt(8) = 0.d0	!Tgas
    get_imass_sqrt(9) = 0.d0	!dummy
  ...
  function get_imass()
    ...
    get_imass(1) = 2.1347243650594476d+22	!N2
    get_imass(2) = 3.7357676388540333d+22	!O
    get_imass(3) = 1.9924094073888177d+22	!NO
    get_imass(4) = 4.269448730118895d+22	!N
    get_imass(5) = 1.8678838194270166d+22	!O2
    get_imass(6) = 0.d0	!CR
    get_imass(7) = 0.d0	!g
    get_imass(8) = 0.d0	!Tgas
    get_imass(9) = 0.d0	!dummy
  ...
  function get_charges()
    ...
    get_charges(1) = 0.d0 	!N2
    get_charges(2) = 0.d0 	!O
    get_charges(3) = 0.d0 	!NO
    get_charges(4) = 0.d0 	!N
    get_charges(5) = 0.d0 	!O2
    get_charges(6) = 0.d0 	!CR
    get_charges(7) = 0.d0 	!g
    get_charges(8) = 0.d0 	!Tgas
    get_charges(9) = 0.d0 	!dummy
