...
contains
  ...
  function get_mass()
    ...
    get_mass(3) = 8.0304780436512d-23	!O3
    get_mass(4) = 0.d0	!CR
    get_mass(5) = 0.d0	!g
    get_mass(6) = 0.d0	!Tgas
    get_mass(7) = 0.d0	!dummy
  ...
  function get_imass_sqrt()
    ...
    get_imass_sqrt(3) = 111591033672.87225	!O3
    get_imass_sqrt(4) = 0.d0	!CR
    get_imass_sqrt(5) = 0.d0	!g
    get_imass_sqrt(6) = 0.d0	!Tgas
    get_imass_sqrt(7) = 0.d0	!dummy
  ...
  function get_imass()
    ...
    get_imass(3) = 1.2452558796180112d+22	!O3
    get_imass(4) = 0.d0	!CR
    get_imass(5) = 0.d0	!g
    get_imass(6) = 0.d0	!Tgas
    get_imass(7) = 0.d0	!dummy
