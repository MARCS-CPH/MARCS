...
module krome_commons
  ...
  ! *************************************************************
  integer,parameter::idx_O2=1
  integer,parameter::idx_O=2
  integer,parameter::idx_M=3
  integer,parameter::idx_O3=4
  integer,parameter::idx_CR=5
  integer,parameter::idx_g=6
  integer,parameter::idx_Tgas=7
  integer,parameter::idx_dummy=8
  integer,parameter::nrea=8
  integer,parameter::nmols=4
