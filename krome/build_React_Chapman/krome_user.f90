...
module krome_user
  ...
  integer,parameter::KROME_idx_O2 = 1	!O2
  integer,parameter::KROME_idx_O = 2	!O
  integer,parameter::KROME_idx_M = 3	!M
  integer,parameter::KROME_idx_O3 = 4	!O3
  integer,parameter::KROME_idx_CR = 5	!CR
  integer,parameter::KROME_idx_g = 6	!g
  integer,parameter::KROME_idx_Tgas = 7	!Tgas
  integer,parameter::KROME_idx_dummy = 8	!dummy
  ...
  integer,parameter::krome_nrea=8
  integer,parameter::krome_nmols=4
  integer,parameter::krome_nspec=8
...
contains
  ...
  function krome_get_names_header()
    ...
    use krome_getphys
    implicit none
    character*10::krome_get_names_header
    character*16::tmp(nspec)
    integer::i
