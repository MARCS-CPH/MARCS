...
C the 15 charged species we list in the output (...dat) are:
      dimension kions(15)
      data kions/15,46,389,414,453,456,462,22,55,447,454,463,466,2*0/
C               H2+ OH+ AL+ CA+ K+ Mg+ Na+ H2- OH- H- K- NA- O- sum+ pe
C the 45 neutral molecules we list in the output (...dat) are:
      dimension k1mol(15)
...
C   ALL OUTPUT CAN BE CHANGED WITH REGARD TO YOUR PREFERENCES
